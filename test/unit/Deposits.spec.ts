...
describe('unit/Deposits', () => {
  ...
  describe('nft#safeTransferFrom', () => {
    ...
    //     rewardToken: context.rewardToken,
    //     rewardCalc: context.poolObj.address,
    //     poolAddress: context.poolObj.address,
  ...
  //       ).to.be.revertedWith('UniversalV3Staker::onERC721Received: not a univ3 nft')
  //     })
  //
  ...
  //             invalidData
  //           )
  //       ).to.be.revertedWith('UniversalV3Staker::stakeToken: non-existent incentive')
  //     })
  //   })
  // })
  //
  ...
  //         'UniversalV3Staker::withdrawToken: only owner can withdraw token'
  //       )
  //     })
  //
  ...
  //         'UniversalV3Staker::withdrawToken: cannot withdraw token while staked'
  //       )
  //     })
  //   })
  // })
  ...
  //       'UniversalV3Staker::transferDeposit: can only be called by deposit owner'
  //     )
  //   })
  //
  ...
  //       'UniversalV3Staker::transferDeposit: invalid transfer recipient'
  //     )
  //   })
  //
